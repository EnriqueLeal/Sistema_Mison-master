...
include '../configuracion/conexion.php';
	...
	$qry2 = "SELECT orden_compra.id, proveedores.proveedor, sucursales.nombre, orden_compra.cantidad, orden_compra.fecha_llegada, orden_compra.usuario 
        FROM orden_compra
	...
	$consulta = mysqli_query($conexion, $qry2);
 ?>
		        ...
		        $("#formulario").on("submit", function(e){
			     ...
			     processData: false
		                ...
		                .done(function(res){
		                    ...
		                    window.location="entregadas.php";
		                });
		        });
		    });
	</script>
