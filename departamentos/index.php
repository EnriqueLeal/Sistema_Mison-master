				...
				<div class="row">
					<div class="col-md-12">
                        ...
                        if (isset($_GET['existe'])) {
                            ...
                            {
                                echo "<script>";
                                echo "alert('¡El departamento ya existe!');";  
                      ...
                      ?>
						...
						<form action="insertar_departamentos.php" method="POST" id="formulario">
						
							<div class="form-group col-md-6">
								<label for="clave_depto">Clave: </label>
								<input type="text" class="form-control" id="clave_depto" name="clave_depto" placeholder="Ej. 10" autofocus="" required>
							</div>

							<div class="form-group col-md-6">
								<label for="departamento">Departamento: </label>
								<input type="text" class="form-control" id="departamento" placeholder="Ej. Libros y Revistas (54)" name="departamento" required>
							</div>
							...
							<div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;">
								<input type="submit" value="Registrar" class="btn btn-danger"></div>
